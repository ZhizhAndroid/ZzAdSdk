...
public class SPUtils {
    ...
    public static SPUtils getInstance(String spName) {
        if (isSpace(spName)) spName = "zzoffersdk";
    ...
    private SPUtils(String spName) {
        sp =    ZzAdSdk.getInstance().getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
     ...
     * @return 存在返回对应值，不存在返回默认值{@code ""}
     */
    public String getString2(@NonNull String key) {
